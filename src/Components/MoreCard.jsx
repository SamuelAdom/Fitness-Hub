...
const MoreCard = () => {
  return (
    <div className="group flex flex-col justify-start items-start gap-2 w-104 h-56 duration-500 relative rounded-lg p-4 bg-transparent hover:-translate-y-2 hover:shadow-xl shadow-[#C6FF00]">
