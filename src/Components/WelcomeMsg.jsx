  ...
  return (
    <div className=" flex flex-col lg:flex-row  bg-[#393E41]">
      <div className="flex flex-col mt-18 p-3 md:p-10 lg:p-30 md:mt-0 space-y-7">
        ...
        <p className="text-md md:text-lg font-extrabold text-white w-150">SINCE DAY ONE, OUR GYM CLASSES HAVE BEEN AN INSPIRING AND WELCOMING EXPERIENCE FOR EVERYONE!</p>
