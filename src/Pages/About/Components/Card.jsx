...
const Card = () => {
  return (
    <div className="relative drop-shadow-xl 2-full mt-10 md:w-full h-50 lg:w-80 lg:mt-30 md:h-60 overflow-hidden bg-[#3d3c3d]">
      <div className="absolute fle text-white z-[1] opacity-90  inset-0.5 bg-[#323132]">
        ...
        {departments.map((item) => (
          <li key={item.id} className="text-[#C6FF00] text-lg lg:text-sm font-medium">
            {item.point}
          </li>
        ))}
      </ul>
